...
- [x] Secure file storage using Amazon S3 object storage
- [x] Single-part and multipart uploads via pre-signed URLs
- [x] Efficient large file handling with chunking
- [x] User-scoped file access and permissions
- [x] PostgreSQL-backed persistence for users and file metadata
- [x] RESTful backend API built with Spring Boot
- [x] Modern frontend built with Vue.js
- [ ] Resumable and Abort uploads
- [ ] Sharing file links
